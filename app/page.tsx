          ...
          <Card className="col-span-1 md:col-span-2 border-muted bg-muted/20 opacity-90 hover:opacity-100 transition-opacity">
            <CardHeader>
              ...
              <CardDescription className="space-y-2 pt-2">
                ...
                <ul className="grid sm:grid-cols-2 gap-2 text-sm list-disc pl-4 pt-1">
                  <li>
                    <strong>Carta Natal & Dracónica:</strong> Tu propósito vital y viaje del alma
                    (Visión M. Blaquier).
                  </li>
                  <li>
                    <strong>Calendario Personal:</strong> Tránsitos diarios y semanales exclusivos.
                  </li>
                  <li>
                    <strong>Journal Lunar:</strong> Sincroniza proyectos con las fases lunares.
                  </li>
                  <li>
                    <strong>Astrogematría:</strong> Descubre el valor vibracional de tus palabras.
                  </li>
                </ul>
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="outline"
                asChild
                className="w-full hover:bg-primary/5 hover:text-primary transition-colors border-primary/20"
              >
                <Link href="/upgrade">Ver Planes Disponibles</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
