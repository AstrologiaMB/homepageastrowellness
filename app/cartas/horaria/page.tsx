...
export default function CartasHorariaPage() {
  ...
  const onSubmit = async (data: HorariaFormData) => {
    ...
    try {
      ...
      alert("¡Solicitud de carta horaria enviada con éxito! Te contactaremos pronto con la respuesta.");
      router.push("/");
    } catch (error) {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <FormLabel>
                      ¿Es la primera vez que haces esta pregunta, a cualquier oráculo? Si ya fue formulada, la carta horaria pierde validez.
                    </FormLabel>
                    <FormControl>
                      <RadioGroup
                        onValueChange={field.onChange}
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-muted-foreground space-y-2">
                  <p>
                    <strong>Es preferible aportar un marco de tiempo a la pregunta.</strong><br />
                    Por ejemplo: ¿Formaré una relación en los próximos 6 meses? ¿Venderé la casa este año?
                  </p>
                  <p>
                    <strong>El Astrólogo NO es vidente, por eso es importante especificar el contexto.</strong><br />
                    Por ejemplo, ante la pregunta ¿Retomaré el vínculo con Juan en este año? Es necesario especificar si Juan es un amigo, o un hermano, o un hijo. Aclarar hace cuanto que no se ven o comunican, etc.
                  </p>
                  <p>
                    <strong>Importante:</strong> Si no provees el contexto en tu pregunta inicial, y luego al recibir tu respuesta, decides proveer el contexto, no se enviará una nueva respuesta.
                  </p>
                  <p>
                    <strong>La carta horaria debe reflejar la realidad. Cuanto más contexto se aporte al Astrólogo, más precisa será la respuesta.</strong><br />
                    Por ejemplo, si se pregunta por un trabajo o una mascota o un objeto perdido, conviene dar una breve descripción de este y toda la información relevante para una interpretación más fidedigna.
                  </p>
                  <p>
                    <strong>La carta horaria puede, en algunos casos brindar tiempos aproximados. Esto no siempre es posible.</strong>
                  </p>
                  <p>
                    <strong>Para que la respuesta sea efectiva, evitar preguntas que contengan más de una opción</strong>, del tipo: "¿Conviene la opción A o B?". En casos como este, debe formularse la pregunta eligiendo la alternativa que uno prefiere.
                  </p>
                </div>
