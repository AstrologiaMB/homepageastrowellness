...
export function ComparisonTable() {
    ...
    return (
        <section className="py-10 md:py-14 lg:py-20 bg-[#080b12] border-t border-white/5 text-white">
            <div className="container px-4 md:px-6 max-w-4xl mx-auto">
                <div className="text-center mb-6 md:mb-8 lg:mb-12">
                    <h2 className="text-2xl sm:text-3xl font-bold font-serif mb-3 md:mb-4">La Evolución de tu Agenda</h2>
                    <p className="text-sm sm:text-base text-gray-400">¿Por qué conformarte con generalidades cuando puedes tener precisión?</p>
                </div>

                <div className="overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm">
                    <div className="grid grid-cols-12 bg-white/5 p-2.5 md:p-3 text-xs sm:text-sm font-semibold uppercase tracking-wider text-gray-400">
                    ...
                    <div className="divide-y divide-white/5">
                        {features.map((feature, idx) => (
                            <div key={idx} className="grid grid-cols-12 items-center p-2.5 md:p-3 hover:bg-white/5 transition-colors">
                                {/* Feature Name */}
                                ...
                                <div className="col-span-4 md:col-span-3 flex flex-col items-center justify-center text-center">
                                    ...
                                    <div className="flex items-center gap-2 text-gray-500">
                                        <X className="h-4 w-4" />
                                        <span className="text-xs sm:text-sm hidden md:inline">{feature.traditional}</span>
                                    </div>
                                </div>
                                ...
                                <div className="col-span-4 md:col-span-4 flex flex-col items-center justify-center text-center bg-[#D4AF37]/5 -my-4 py-6 border-x border-[#D4AF37]/10">
                                    ...
                                    <div className="flex items-center gap-2 text-[#D4AF37] font-semibold">
                                        ...
                                        <span className="text-xs sm:text-sm hidden md:inline">{feature.astrochat}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
