...
export function ComparisonTable() {
    ...
    return (
        <section className="py-12 md:py-16 lg:py-24 bg-[#080b12] border-t border-white/5 text-white">
            <div className="container px-4 md:px-6 max-w-4xl mx-auto">
                ...
                <div className="overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm">
                    <div className="grid grid-cols-12 bg-white/5 p-3 md:p-4 text-xs sm:text-sm font-semibold uppercase tracking-wider text-gray-400">
                    ...
                    <div className="divide-y divide-white/5">
                        {features.map((feature, idx) => (
                            <div key={idx} className="grid grid-cols-12 items-center p-3 md:p-4 hover:bg-white/5 transition-colors">
                                {/* Feature Name */}
